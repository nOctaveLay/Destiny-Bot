...
def print_gos_first_named():
    ...
    result_string += f"보스 : {boss_list[0]}, {boss_list[1]}, {boss_list[2]} 연결 : {connect_list[3]}, {connect_list[4]}, {connect_list[5]}"
...
def print_gos_sec_named():
    ...
    people_list = [x+1 for x in range(6)]
    random.shuffle(people_list)
    result_string += f"6시:{people_list[0]}, 9시:{people_list[1]}, 12시:{people_list[2]}, 3시:{people_list[3]}, 12-3시:{people_list[4]}, 6-9시:{people_list[5]}"
    return result_string
...
def print_gos_third_named():
    ...
    people_list = [x+1 for x in range(6)]
    random.shuffle(people_list)
    result_string += f"보스 : {people_list[0]}, {people_list[1]}, {people_list[2]} 티끌 : {people_list[3]}, {people_list[4]}, {people_list[5]}"
    return result_string
